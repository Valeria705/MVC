...
namespace VersionMVC5.Controllers
{
    public class EspecialidadsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Especialidad,Nom_Especialidad")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Especialidad,Nom_Especialidad")] Especialidad especialidad)
        {
            if (ModelState.IsValid)
            {
